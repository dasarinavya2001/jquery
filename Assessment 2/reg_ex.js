...
function check_address(){
    ...
    if(address.length < 15){
        document.getElementById("msg4").innerHTML = "Enter Atleast 15 Charectors"
        return false
    }else{
...
function reg_ex_email(){
    ...
    if(reg_ex_email.test(mail)){
        document.getElementById("msg6").innerText = ""
        return false
    }else{
        document.getElementById("msg6").innerText ="InValid.....!!!"
        return false
    }
}
// ========Password=======
...
function check_mobile(){
    ...
    if(reg_mo_ex.test(mobile)){
        ...
        document.getElementById("msg9").innerText = "Alphabit Not Allowed"
        return false;
    }
}
// ========check length======
function check_mobile_length(){
    ...
    if(mobile.length < 10){
        ...
        document.getElementById("msg10").innerText = "Alphabit Not Allowed"
        return false;
    }
}